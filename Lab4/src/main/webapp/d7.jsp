...
<form action="d7.jsp" method="">
    <h2>search Here</h2>
   Date: <input type="text" placeholder="id" id="i1" name="id7">
...
<%
if(request.getParameter("id7")!=null){
	String n=request.getParameter("id7");
	%>
...
%>
 ...
 <h2>Sales on particular date</h2>
 
    <div class="table-wrapper"> 
<table border="1" width="90%">  
<tr><th>On Date Count</th>  
<tr><td>${list}</td>
