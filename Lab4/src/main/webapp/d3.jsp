...
<tr><th>Id</th><th> Name</th><th> Watch Name</th><th>Quantity</th><th> Date</th>
<c:forEach items="${list}" var="u">  
<tr><td>${u.getCid()}</td><td>${u.getCname()}</td><td>${u.getWname()}</td><td>${u.getQty()}</td> <td>${u.getDate2()}</td>
