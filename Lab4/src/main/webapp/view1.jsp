...
<nav class="nav nav_top">
            ...
            <div class="nav_side">
             <a href="d6.jsp">purchase</a>
            <a href="d5.jsp">dealer</a>
                 <a href="d4.jsp">age</a>
                 <a  href="d3.jsp">Date</a>
                  <a  href="d2.jsp">Costly W_Customer</a>
                 <a  href="d1.jsp">Price in range</a>
                 <a  href="a1.jsp">Watch</a>
                 <a  href="d7.jsp">On date</a>
...
<div id="q1">
<%
List<purchase> list=addpurchase.getAll1();  
...
<tr><th>Id</th><th>Watch Name</th></tr>  
<c:forEach items="${list}" var="u">  
<tr><td>${u.getId()}</td><td>${u.getWname()}</td>  
