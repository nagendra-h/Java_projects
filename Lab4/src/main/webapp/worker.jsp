...
<div id="container_2">
  ...
  <form id="survey-form" action="addworker.jsp" method="post">
   <table border=1>  
...
<tr><td>Phone no:</td><td>  
 ...
 <input type="submit" class="submit"  type="submit" value="Add Worker"/>  
   <a href="vieeworker.jsp" class="submit">View All Records</a>  
