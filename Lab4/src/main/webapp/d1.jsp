...
<%
List<billing1> list=b1.getAll3();  
request.setAttribute("list",list); 
%>  
 <div class="outer-wrapper">
 <h2>Watches price range from 500-1000</h2>
 
    <div class="table-wrapper"> 
<table border="1" width="90%">  
<tr><th>Id</th><th>Watch Name</th><th>Quantity</th><th>Price</th></tr>  
<c:forEach items="${list}" var="u">  
<tr><td>${u.getWid()}</td><td>${u.getWname()}</td>  <td>${u.getQty()}</td><td>${u.getPrice()}</td>
