...
<tr><td>Watch company:</td><td><input type="text" name="wname"/></td></tr>  
...
<input type="submit" class="submit" value="Add purchase"/>
<a href="viewpurchase.jsp" class="submit">View All Records</a><br/>
</form> </div>
<%}%>
</body>
</html>